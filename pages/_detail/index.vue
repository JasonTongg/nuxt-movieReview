          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="blog__details__hero__text">
                <h2>{{ $route.params.detail.name }}</h2>
                <ul>
                  <li>{{ $route.params.detail.category }}</li>
                  <li>Rerelease: {{ $route.params.detail.year_release }}</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div class="col-lg-8 col-md-4 blog__details__content">
              <div class="blog__details__text">
                <div class="blog__details__text__img">
                  <img :src="$route.params.detail.image_url" alt="" />
                </div>
                <p>{{ $route.params.detail.review }}</p>
              </div>
            </div>
          </div>
        </div>
